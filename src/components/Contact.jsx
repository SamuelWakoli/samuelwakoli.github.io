      ...
      <div className="container mx-auto px-6 max-w-4xl text-center">
        <div className="glass-card rounded-3xl p-8 md:p-16 relative overflow-hidden">
          ...
          <p className="text-slate-300 mb-10 text-lg relative z-10 max-w-2xl mx-auto font-light">
            ...
            question about a project or just want to say hi, my inbox is always
            open!
          </p>
          ...
          <div className="flex justify-center relative z-10">
            <a
              ...
              className="group flex items-center gap-3 px-8 py-4 bg-white text-slate-900 rounded-full hover:bg-blue-50 transition-all font-bold shadow-[0_0_20px_rgba(255,255,255,0.3)] hover:shadow-[0_0_30px_rgba(255,255,255,0.5)] transform hover:-translate-y-1"
            >
          ...
          <div className="flex justify-center gap-8 mt-16 pt-8 border-t border-slate-700/50 relative z-10">
            <a
              ...
              target="_blank"
              className="p-3 bg-slate-800/50 rounded-full text-slate-400 hover:text-white hover:bg-slate-700 transition-all transform hover:scale-110"
            >
