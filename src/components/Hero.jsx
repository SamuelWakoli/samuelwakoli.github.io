...
export const Hero = () => {
    return (
        <section className="min-h-screen flex items-center justify-center px-6 pt-20 overflow-hidden relative" id="home">
            {/* Background Elements */}
            ...
            <div className="container mx-auto grid lg:grid-cols-2 gap-12 items-center relative z-10">
                ...
                >
                    ...
                    >
                        ...
                        <span className="text-blue-200 text-sm font-medium tracking-wide">Available for Hire</span>
                    </motion.div>
                    ...
                    <h1 className="text-5xl md:text-7xl font-bold mb-6 text-white tracking-tight leading-tight">
                        ...
                        <br />
                        <span className="text-slate-400 text-4xl md:text-6xl">{profile.role}</span>
                    </h1>
                    ...
                    <div className="flex flex-wrap gap-4">
                        <a href="/resume.pdf" target="_blank" className="group flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-full hover:shadow-lg hover:shadow-blue-500/25 transition-all transform hover:-translate-y-1 font-medium">
                            <FileText size={20} />
                            <span>Resume</span>
                            <ArrowRight size={18} className="group-hover:translate-x-1 transition-transform" />
                        </a>

                        <a href={profile.social.github} target="_blank" rel="noopener noreferrer" className="p-4 glass-card rounded-full text-slate-300 hover:text-white hover:border-blue-500/50 transition-all transform hover:-translate-y-1">
                            <Github size={22} />
                        </a>
                        {profile.social.linkedin && (
                            <a href={profile.social.linkedin} target="_blank" rel="noopener noreferrer" className="p-4 glass-card rounded-full text-slate-300 hover:text-white hover:border-blue-500/50 transition-all transform hover:-translate-y-1">
                                <Linkedin size={22} />
                            </a>
                        )}
                        <a href={`mailto:${profile.social.email}`} className="p-4 glass-card rounded-full text-slate-300 hover:text-white hover:border-blue-500/50 transition-all transform hover:-translate-y-1">
                            <Mail size={22} />
                        </a>
                    </div>
