            ...
            <div className="container mx-auto px-6 max-w-4xl">
                <div className="glass-card p-8 md:p-12 rounded-3xl relative overflow-hidden">
                    ...
                    <div className="prose prose-lg prose-invert mx-auto text-slate-300 text-center md:text-left">
                        <p className="mb-6 leading-relaxed text-lg text-center font-light">{profile.bio}</p>
                        <p className="leading-relaxed text-lg text-center font-light">
                            ...
                            My journey has been driven by a logical, persistent problem-solving style and a dedication to learning new technologies.
                        </p>
                    </div>
                </div>
            </div>
