...
import { Menu, X, User, Code, Briefcase, GraduationCap, Award, Trophy, Mail } from 'lucide-react'
                    ...
                    <>
                        ...
                        >
                            ...
                            <div className="p-6 flex justify-between items-center border-b border-white/5 bg-white/5">
                                <span className="text-xl font-bold bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent tracking-widest uppercase text-sm">Menu</span>
                                <button
                                    onClick={() => setIsOpen(false)}
                            ...
                            <div className="p-6 border-t border-white/5 bg-slate-950/30">
                                <a href="/resume.pdf" target="_blank" className="w-full flex items-center justify-center gap-3 py-4 bg-gradient-to-r from-blue-600 to-blue-500 text-white rounded-xl font-bold shadow-lg shadow-blue-500/20 hover:shadow-blue-500/40 hover:scale-[1.02] transition-all">
