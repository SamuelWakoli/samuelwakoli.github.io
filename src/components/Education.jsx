                        ...
                        <div key={index} className="glass-card p-8 rounded-3xl relative overflow-hidden group">
                            ...
                            <div className="relative z-10">
                                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-4">
                                    <h3 className="text-2xl font-bold text-white group-hover:text-blue-400 transition-colors">{edu.school}</h3>
                                    <div className="flex items-center gap-2 text-slate-400 bg-slate-800/50 px-3 py-1 rounded-full text-sm">
                                        <Calendar size={14} />
                                        <span>{edu.year}</span>
                                    </div>
                                </div>
                                <div className="text-xl text-blue-200 mb-4 font-medium">{edu.degree}</div>
