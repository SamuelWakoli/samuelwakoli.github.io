...
export const StackCard = () => {
    ...
    return (
        <Card className="col-span-12 md:col-span-4 row-span-1 overflow-hidden" noPadding>
            ...
            <div className="relative flex overflow-x-hidden mt-6 pb-8 pointer-events-none fade-x-mask">
                ...
                >
                    {skills.map((skill, i) => (
                        <div key={i} className="flex-shrink-0 w-16 h-16 bg-slate-800/50 rounded-xl flex items-center justify-center border border-slate-700/50">
